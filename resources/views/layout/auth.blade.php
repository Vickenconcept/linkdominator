    ...
    <div class="relative flex flex-col h-full max-h-full">
        ...
        <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="flex flex-col space-y-1">
                ...
                <li>
                    <a href="{{route('aiwriter.index')}}" data-tooltip="Ai Writer" class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 {{ in_array(Route::current()->getName(), ['aiwriter.index','aiwriter.create','aiwriter.edit']) ? 'bg-gray-100':'' }}">
                ...
                <li>
                    <a href="{{route('content-creator.index')}}" data-tooltip="Content Creator" class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 {{ in_array(Route::current()->getName(), ['content-creator.index','content-creator.create','content-creator.edit']) ? 'bg-gray-100':'' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
