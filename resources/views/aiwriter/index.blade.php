...
<div class="flex justify-between">
    ...
    <div class="flex gap-2">
        ...
        flex" style="background: linear-gradient(135deg, #0077b5 0%, #005885 100%);" onmouseover="this.style.background='linear-gradient(135deg, #005885 0%, #004d6f 100%)'; this.style.boxShadow='0 4px 12px rgba(0, 119, 181, 0.3)';" onmouseout="this.style.background='linear-gradient(135deg, #0077b5 0%, #005885 100%)'; this.style.boxShadow='none';">
    ...
    <div class="w-full overflow-hidden rounded-lg">
        <div class="w-full overflow-x-auto">
            ...
            <div>
                ...
                <div class="grid grid-cols-12 gap-x-3 p-3 px-3 mb-2 bg-white hover:bg-blue-50 border border-gray-200 rounded-lg shadow-sm font-normal cursor-pointer text-gray-600 text-sm content-list-{{$content->id}}">
                    <div class="col-span-3">
                        <a href="{{route('aiwriter.edit', ['id' => $content->id])}}" class="text-[#0077b5] hover:text-[#005885] hover:underline">
                            {{$content->title}}
                        </a>
                    </div>
                    <div class="col-span-3">
                    ...
                    <div class="col-span-2">
                        <div class="flex gap-3">
                            <a href="{{route('aiwriter.edit', ['id' => $content->id])}}" class="open-update-content-modal text-[#0077b5] hover:text-[#005885]">
                            ...
                            <form action="{{route('aiwriter.delete', ['id' => $content->id])}}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="open-delete-content-modal text-[#0077b5] hover:text-[#005885]" >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
