<div>
    ...
    <div class="mt-2 mb-5">
        <div>
            ...
            <div class="grid grid-cols-12 items-center p-4 mb-3 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div class="col-span-4 flex gap-4 font-semibold text-sm text-gray-800">
                    <div class="bg-gray-100 rounded-full p-1" style="color: #0077b5;">
                ...
                <div class="col-span-4 flex justify-between">
                    ...
                    <form action="{{route('campaign.removelist', ['id' => $item->id])}}" method="post">
                        ...
                        <button class="text-xs font-normal text-center text-red-500 hover:text-red-700 focus:border-0 p-0 focus:ring-0 transition-colors" type="submit">
    ...
    <div id="hs-scale-animation-modal" class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-scale-animation-modal-label">
        <div class="hs-overlay-animation-target hs-overlay-open:scale-100 hs-overlay-open:opacity-100 scale-95 opacity-0 ease-in-out transition-all duration-200 sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-56px)] flex items-center">
            <div class="w-full flex flex-col bg-white border border-gray-200 shadow-md rounded-xl pointer-events-auto">
                ...
                <form action="{{route('campaign.store')}}" method="post">
                    ...
                    <div class="p-4 overflow-y-auto">
                        ...
                        <label for="leadlist" class="block mb-2 text-sm font-medium text-gray-900">Select a lead list</label>
                        <select id="leadlist" name="type"  class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-[#0077b5] focus:ring-[#0077b5] disabled:opacity-50 disabled:pointer-events-none" style="border-color: rgba(0, 119, 181, 0.2);" required="">
                    ...
                    <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t border-gray-200">
                        <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-scale-animation-modal">
                        Close
                        </button>
