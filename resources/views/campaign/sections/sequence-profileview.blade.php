<h4 class="mb-2 font-semibold">Extra Profile Views</h4>
<div class="flex flex-row gap-3">
    <div class="w-full bg-gray-100 rounded min-h-screen">
        <div id="myProfileviewDiagramDiv" style="width:100%; min-height:100%"></div>
    </div>
</div>
<div class="pt-3 mb-4">
    ...
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all md:max-w-2xl md:w-full m-3 md:mx-auto">
        <div class="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            ...
            <div class="p-4 overflow-y-auto">
                <!-- Delay fields -->
                <div id="delay-fields" class="bg-white rounded-lg profileview-sequence-fields w-64" style="display: none;">
...
if(dbSequenceType === 'profile_views' && dbSequenceNode.length > 0 && dbSequenceLink.length > 0){
    nodeDataModel = dbSequenceNode
    linkDataModel = dbSequenceLink
}else {
    nodeDataModel = [
        {key: 0, icon: "\uf06e", label: "View profile", type: 'action', value: 'profile-view', time: '',    color: "#5560E5", stroke: "white",  loc: "50 0",   runStatus: false},
        {key: 1, icon: "\uf017", label: "5 hours",      type: 'delay',  value: 5, time: 'hours',            color: "#F3F4F6", stroke: "black",  loc: "50 60",  runStatus: false},
        {key: 2, icon: "\uf2bb", label: "Follow",       type: 'action', value: 'follow', time: '',          color: "#5560E5", stroke: "white",  loc: "50 120", runStatus: false},
        {key: 3, icon: "\uf017", label: "5 days",       type: 'delay',  value: 5, time: 'days',             color: "#F3F4F6", stroke: "black",  loc: "50 180", runStatus: false},
        {key: 4, icon: "\uf06e", label: "View profile", type: 'action', value: 'profile-view', time: '',    color: "#5560E5", stroke: "white",  loc: "50 240", runStatus: false},
        {key: 5, icon: "\uf017", label: "5 days",       type: 'delay',  value: 5, time: 'days',             color: "#F3F4F6", stroke: "black",  loc: "50 300", runStatus: false},
        {key: 6, icon: "\uf164", label: "Like a post",  type: 'action', value: 'like-post',   time: '',     color: "#5560E5", stroke: "white",  loc: "50 360", runStatus: false},
        {key: 7, icon: "\uf017", label: "5 days",       type: 'delay',  value: 5, time: 'days',             color: "#F3F4F6", stroke: "black",  loc: "50 420", runStatus: false},
        {key: 8, icon: "\uf06e", label: "View profile", type: 'action', value: 'profile-view', time: '',    color: "#5560E5", stroke: "white",  loc: "50 480", runStatus: false},
        {key: 9, icon: "\uf017", label: "No delay",     type: 'delay',  value: 0,  time: 'hours',           color: "#F3F4F6", stroke: "black",  loc: "50 540", runStatus: false},
        {key: 10,icon: "\uf05e", label: "End of sequence", type: 'end', value: 'end', time: null,           color: "#9ca3af", stroke: "white",  loc: "50 600", runStatus: false},
    ]
    linkDataModel = [
        {from: 0, to: 1},
        {from: 1, to: 2},
...
const initProfileView = () => {
    const diagram = new go.Diagram("myProfileviewDiagramDiv");
    ...
    const load = () => {
        ...
        diagram.addDiagramListener('ObjectSingleClicked', function(e){
            ...
            for(let elem of document.querySelectorAll('.profileview-sequence-fields')){
                elem.style.display = 'none'
            }
            applyActionBtn.style.display = 'none'
            
            if(nodeItem.type == 'delay'){
                document.querySelector('.profile-view-modal-btn').click()
    ...
    applyActionMain.addEventListener('click', () => {
        ...
        // applyActionMain.style.display = 'none'
    })
...
const saveSequence = async () => {
    ...
    formData.append('sequence_type', 'profile_views');
    ...
    let submitSequenceBtn = document.querySelector('.submit-profileview-sequence')
