                    ...
                    <div class="col-span-2">
                        ...
                        <form action="{{route('team.delete', ['tab' => request()->query('tab')])}}" method="post">
                            ...
                            <div class="hs-tooltip inline-block">
                                <button type="submit" class="hs-tooltip-toggle text-xs font-normal text-center text-gray-500 hover:text-[#0077b5] focus:border-0 p-1 focus:ring-0 transition-colors" >
