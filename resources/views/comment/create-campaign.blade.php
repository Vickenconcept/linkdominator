...
@section('content')
<div class="block mt-4 p-6 bg-white border border-gray-200 rounded-lg shadow">
    <div class="pb-4">
        <ol class="items-center justify-between w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0 rtl:space-x-reverse">
            <li class="flex items-center text-indigo-600 space-x-2.5 rtl:space-x-reverse">
                <span class="flex items-center justify-center w-8 h-8 border border-indigo-600 rounded-full shrink-0 bg-indigo-600 text-white">
                    1
                </span>
                <span>
            ...
            <li class="flex items-center space-x-2.5 rtl:space-x-reverse text-gray-500
                ...
                <span class="flex items-center justify-center w-8 h-8 border border-gray-500 rounded-full shrink-0                {{ request()->query('step') == 'search' || request()->query('step') == 'ai_commenter' || request()->query('step') == 'final' ? 'border-indigo-600 bg-indigo-600 text-white': '' }}">
                    3
                </span>
                <span>
            ...
            <li class="flex items-center space-x-2.5 rtl:space-x-reverse text-gray-500
                ...
                <span class="flex items-center justify-center w-8 h-8 border border-gray-500 rounded-full shrink-0                {{ request()->query('step') == 'ai_commenter' || request()->query('step') == 'final' ? 'border-indigo-600 bg-indigo-600 text-white': '' }}">
                    4
                </span>
                <span>
            ...
            <li class="flex items-center space-x-2.5 rtl:space-x-reverse text-gray-500
                ...
                <span class="flex items-center justify-center w-8 h-8 border border-gray-500 rounded-full shrink-0                {{ request()->query('step') == 'final' ? 'border-indigo-600 bg-indigo-600 text-white': '' }}">
                    5
                </span>
                <span>
